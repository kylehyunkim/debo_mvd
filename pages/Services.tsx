  ...
  return (
    <div className="pt-32 pb-24">
      <div className="container mx-auto px-4 md:px-8">
            ...
            >
              ...
              <div className="md:w-1/2">
                ...
                <ul className="space-y-3 mb-8">
                  {['Expert Planning', 'Professional Sources', 'Dedicated Project Management', 'Attention to Detail'].map((item, i) => (
                ...
                <a href="#/contact" className="inline-block bg-gray-900 text-white px-8 py-3 text-xs font-bold uppercase tracking-widest hover:bg-[#5bb450] transition-colors">
                  Request Estimate
                </a>
              </div>
            </div>
        ...
        {/* Process Section */}
        <div className="mt-32 p-12 bg-gray-900 text-white rounded-lg shadow-2xl relative overflow-hidden">
